        ...
        override fun visitPhpFunctionCall(element: FunctionReference) {
            ...
            ProblemsHolderService.instance.registerProblem(
                ...
                QuickFixService.instance.simpleInline("Replace with null-safe operator") {
                    ...
                    val elementParentLocal =
                        (elementParentPointer.element ?: return@simpleInline) as? MemberReferenceImpl ?: return@simpleInline

                    if (elementParentLocal.isNullSafeDereference)
                        return@simpleInline

                    val elementParentArrow =
                        PhpPsiUtil.getNextSiblingIgnoreWhitespace(elementParentLocal.classReference, true) ?: return@simpleInline
