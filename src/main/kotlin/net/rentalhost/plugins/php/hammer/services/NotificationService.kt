...
object NotificationService {
    ...
    data class NotificationItem(
        ...
        constructor(name: String, documentTitle: String, buttonTitle: String, url: String) : this(
            name,
            documentTitle,
            buttonTitle,
            url,
        ...
        constructor(name: String, documentTitle: String, url: String, callback: (Notification) -> Unit) : this(
            name,
            documentTitle,
            documentTitle,
            url,
