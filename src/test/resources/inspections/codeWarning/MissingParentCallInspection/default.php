...
class Dummy1070_B extends Dummy1070_A
{
    ...
    public function <warning descr="🔨 PHP Hammer: missing parent::testA() call.">testA</warning>()
    {
    }
    ...
    public function <warning descr="🔨 PHP Hammer: missing parent::testB() call.">testB</warning>()
    {
    }
}
