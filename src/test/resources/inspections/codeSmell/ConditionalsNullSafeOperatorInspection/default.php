...
$dummy11000 = $example <weak_warning descr="🔨 PHP Hammer: this operator can be replaced by null-safe operator.">&&</weak_warning>
              $dummy <weak_warning descr="🔨 PHP Hammer: this operator can be replaced by null-safe operator.">&&</weak_warning>
              $example->self &&
              $dummy->dummy;
...
$notApplicable2000 = $example instanceof Example &&
                     $example->isTomorrow();
...
$notApplicable3000 = Example::getSelfStatic() &&
...
$notApplicable4000 = $example->getSelf() &&
...
$notApplicable5000 = $example || $example->self || $example->isTomorrow();
